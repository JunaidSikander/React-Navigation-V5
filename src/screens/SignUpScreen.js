...
const SignUpScreen = ({ navigation }) => {
    ...
    const updateConfirmSecureTextEntry = () => setData({...data, confirm_secureTextEntry: !data.confirm_secureTextEntry});
            ...
            <Animatable.View style={styles.footer} animation='fadeInUpBig'>
                ...
                <View style={styles.action}>
                    ...
                    <TouchableOpacity onPress={updateConfirmSecureTextEntry}>
                        <Feather name={data.confirm_secureTextEntry ? 'eye' : 'eye-off'} color='gray' size={20}/>
                    </TouchableOpacity>
                </View>
